...
const CONFIGS = {
  ...
  "languedoc-roussillon": {
    ...
    keyBase: "france.languedoc-roussillon",
    window: { minLon: 1.9, minLat: 42.3, maxLon: 4.7, maxLat: 44.1 },
    caveats: [
      "The base 'Languedoc' AOC (53818) spans both Languedoc and Roussillon and is the dual-role region place. It plus the big VDN/regional AOCs (Corbieres 11203, Cotes du Roussillon 13562, Rivesaltes 14201, Grand Roussillon 15307, Muscat de Rivesaltes 15307) are HEAVY LIKE fetches - captured in the artifact but the full-geometry preview of those is deferred (run preview-inao-region --only=<slug> per shape).",
      "Comprehensive families by prefix: Languedoc <terroir> (Cabrieres, Gres de Montpellier, La Mejanelle, Montpeyroux, Quatourze, Saint-Christol, Saint-Drezery, Saint-Georges-d'Orques, Saint-Saturnin), Corbieres (+Boutenac), Minervois (+La Liviniere), Saint-Chinian (+Berlou/Roquebrun), Clairette du Languedoc (+11 communes), Cotes du Roussillon (+Villages +4 named), Banyuls (+grand cru).",
      "Clairette de Die belongs to the Rhone/Die, not Languedoc - excluded here.",
    ],
    modeling: "france.languedoc-roussillon region (display 'Languedoc-Roussillon', tier 1): boundary = dissolve of 'Languedoc' at flip time. Big regional/VDN AOCs (Corbieres, Minervois, Cotes du Roussillon, Rivesaltes, Grand Roussillon, Costieres de Nimes, Limoux) = district; crus/terroirs/Muscats = village. is_appellation=true, AOC, GENERALIZED_FROM_OFFICIAL_SOURCE, primary_parent=france.languedoc-roussillon. Grapes: Grenache/Syrah/Mourvedre/Carignan (reds), Picpoul (Pinet), Mauzac (Limoux), Grenache/Muscat (VDN Banyuls/Maury/Rivesaltes). Scoring links exact-name; no exact row -> PENDING. NOT run live - reviewable groundwork pending owner shape-review gate.",
    selectors: [
      { exact: "Languedoc", regionPlace: true },
      { prefix: "Languedoc ", level: "village", keepName: true },
      { exact: "Terrasses du Larzac", level: "village" },
      { exact: "Pic Saint-Loup", level: "village" },
      { exact: "La Clape", level: "village" },
      { exact: "Picpoul de Pinet", level: "village" },
      { prefix: "Clairette du Languedoc", level: "village", keepName: true },
      { exact: "Clairette de Bellegarde", level: "village" },
      { prefix: "Corbières", level: "district", keepName: true },
      { prefix: "Minervois", level: "district", keepName: true },
      { prefix: "Saint-Chinian", level: "village", keepName: true },
      { exact: "Faugères", level: "village" },
      { exact: "Fitou", level: "village" },
      { exact: "Cabardès", level: "village" },
      { exact: "Malepère", level: "village" },
      { exact: "Limoux", level: "district" },
      { exact: "Costières de Nîmes", level: "district" },
      { prefix: "Côtes du Roussillon", level: "district", keepName: true },
      { exact: "Collioure", level: "village" },
      { prefix: "Banyuls", level: "village", keepName: true },
      { exact: "Maury", level: "village" },
      { exact: "Rivesaltes", level: "district" },
      { exact: "Grand Roussillon", level: "district" },
      { exact: "Muscat de Rivesaltes", level: "village" },
      { exact: "Muscat de Frontignan ou Frontignan ou Vin de Frontignan", name: "Muscat de Frontignan", level: "village" },
      { exact: "Muscat de Lunel", level: "village" },
      { exact: "Muscat de Mireval", level: "village" },
      { exact: "Muscat de Saint-Jean-de-Minervois", level: "village" },
    ],
  },
};
