    ...
    (async () => {
      ...
      setData({
        ...
        initial: {
          ...
          // Must be loaded, not left undefined: the form always submits the
          // description and alcohol, so an unloaded one would blank it the
          // first time anyone edited the wine's region.
          alcoholPercent:
