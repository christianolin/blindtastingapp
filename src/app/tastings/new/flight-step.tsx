  ...
  return (
    <div className="flex flex-col gap-[14px]">
      ...
      <div className="relative flex flex-col">
        <div
          className={cn(
            "flex flex-wrap items-center gap-[10px] border border-border bg-surface-raised p-[12px_14px] transition-colors focus-within:border-[1.5px] focus-within:border-primary focus-within:p-[11.5px_13.5px]",
        ...
        {showResults ? (
          <div className="overflow-hidden rounded-b-[10px] border border-t-0 border-gold bg-surface-raised">
            {results.length === 0 ? (
          ...
          <ul className="flex flex-col gap-[7px]">
            {rows.map((w, i) => (
              <li
                ...
                className={cn(
                  "relative flex items-center gap-[10px] rounded-[9px] border border-border bg-surface-raised p-[8px_10px] md:gap-3 md:p-[10px_13px]",
...
function ShortcutChip({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex min-h-11 flex-1 items-center justify-center gap-[5px] rounded-[6px] border border-border bg-background px-2 text-[11.5px] font-semibold text-primary transition-colors hover:border-gold hover:bg-surface-raised md:min-h-0 md:flex-none md:px-2 md:py-[3px]"
    >
