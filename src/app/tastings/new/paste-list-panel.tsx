  ...
  return (
    <div className="flex flex-col gap-[8px] rounded-[10px] border border-dashed border-border bg-background p-[12px_14px]">
      <textarea
        ...
        rows={4}
        disabled={resolving}
        className="min-h-[88px] resize-y rounded-[8px] border border-border bg-white p-[10px_12px] text-[13px] outline-none focus:border-primary disabled:opacity-70"
      />
      <div className="flex items-center gap-3">
        <button
          ...
          className="flex min-h-11 items-center justify-center rounded-[8px] border border-border bg-white px-[14px] text-[12.5px] font-semibold text-primary transition-colors hover:border-gold disabled:opacity-50 md:min-h-9"
        >
