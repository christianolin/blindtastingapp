...
export function StatTile({
  ...
  return (
    <div
      data-slot="stat-tile"
      className={cn(
        "flex items-center gap-2 rounded-xl border border-border bg-card p-2.5 sm:gap-3 sm:p-4",
        className,
      )}
    >
      {Icon ? (
        <span
          className={cn(
            "flex size-7 shrink-0 items-center justify-center rounded-lg sm:size-10",
            TINTS[tint],
          )}
        >
      ...
      <div className="min-w-0">
        <div className="font-heading text-base leading-none font-semibold tabular-nums sm:text-2xl">
          {value}
        </div>
