  ...
  return (
    <Link
      ...
      className={cn(
        ...
        "relative inline-flex shrink-0 items-center gap-[5px] rounded-full border border-border font-semibold whitespace-nowrap text-primary transition-colors hover:border-gold hover:bg-surface-raised max-md:after:absolute max-md:after:inset-x-0 max-md:after:-inset-y-2.5 max-md:after:content-['']",
